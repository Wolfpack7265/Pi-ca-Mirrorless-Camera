...
def main(config_file_path):
    ...
    while True:
        ...
        cv2.namedWindow("Focus Peaking Test", cv2.WINDOW_NORMAL) 
        cv2.resizeWindow("Focus Peaking Test", 960, 540)
        cv2.imshow("Focus Peaking Test", output_frame)
...
#     edges = cv2.Canny(blur, threshold1=205, threshold2=210)
